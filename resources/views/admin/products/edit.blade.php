                    ...
                    <form method="POST" 
                        ...
                        <div>
                            ...
                            <select name="condition" 
                                    id="condition"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                <option value="Bekas - Seperti Baru" {{ old('condition', $product->condition) == 'Bekas - Seperti Baru' ? 'selected' : '' }}>
                                    Bekas - Seperti Baru
                                </option>
                                <option value="Bekas - Mulus" {{ old('condition', $product->condition) == 'Bekas - Mulus' ? 'selected' : '' }}>
                                    Bekas - Mulus
                                </option>
                            </select>
                            @error('condition')
